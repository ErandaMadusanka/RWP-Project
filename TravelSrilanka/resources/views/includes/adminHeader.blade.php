...
<head>
  ...
  <title>Admin Area</title>
   ...
   <link rel="stylesheet" href="{{url('https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css')}}"  type="text/css" />
  ...
  <script src="{{url('https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/4.4.0/bootbox.min.js')}}"></script>
  <script src="{{url('https://unpkg.com/gijgo@1.9.13/js/gijgo.min.js')}}" type="text/javascript"></script>
